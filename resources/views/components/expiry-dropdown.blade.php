<div>
    <div x-data="{ expiry: 'never' }">
        ...
        <select name="expiry" id="expiry" class="form-select w-full" x-model="expiry">
        ...
        <div class="mt-2" x-show="expiry === 'custom'">
            ...
            <input type="datetime-local" name="custom_expiry" id="custom_expiry" class="form-input w-full" />
        </div>
    </div>
</div>
