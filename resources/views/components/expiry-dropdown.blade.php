<div>
    <div x-data="{ expiry: 'never' }">
        <label for="expiry" class="block text-sm font-medium text-white mb-1">Expires In</label>
        ...
        <div class="mt-2" x-show="expiry === 'custom'">
            <label for="custom_expiry" class="block text-sm font-medium text-white mb-1">Select Date & Time</label>
